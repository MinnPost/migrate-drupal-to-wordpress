...
# Section 3 - Core Post Metadata. The order doesn't matter here. We can skip this section if we're testing other stuff.
...
# Section 4 - Tags, Post Formats, and their taxonomies and relationships to posts. The order is important here because we use the term_id from Drupal.
